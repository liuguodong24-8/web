<template>
    <el-dialog
        ...
        :model-value="['ScanList'].includes(baTableSendlist.form.operate!)"
...
const { t } = useI18n(),signTotal = ref<string>('统计中...'),
    ...
    dialogSendlist = ()=>{
        nextTick(()=>{
            ...
            //重置参数对象 filter
            baTable.table.filter = {activity_id: cur_id}
 ...
 */
const baTable = new baTableClass(new baTableApi('/admin/Activityscan/'), {
  pk: 'id',
  column: [
